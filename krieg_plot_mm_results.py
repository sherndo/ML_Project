...
sns.set(style="darkgrid", font_scale=1.8, rc={"lines.linewidth": 3})
...
#sns.relplot(data=df_new, kind='line', x='Test Year',y='Log Loss',hue='Model', style='Model', height=10, aspect=2)
